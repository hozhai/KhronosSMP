...
>
	{@render children?.()}
	<Icon
		icon="pixelarticons:chevron-down-2"
		class="relative top-px ml-1 size-5 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180"
		aria-hidden="true"
	/>
</NavigationMenuPrimitive.Trigger>
