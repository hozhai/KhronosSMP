...
>
	<h1
		class="pointer-events-none absolute top-1/2 left-1/2 z-10 -translate-x-1/2 -translate-y-1/2 bg-linear-to-tr from-green-200 to-green-500 bg-clip-text text-transparent"
	>
		&gt; {frontmatter.title} &lt;
	</h1>
	<h1
	...
	<enhanced:img src={RulesBackground} alt="Info page background" class="-mt-48 w-full" />
</div>
